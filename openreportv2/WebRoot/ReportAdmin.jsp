...
<div align="center">
    ...
    <tr> 
        ...
        <tr class="even">
        <td class="img-export">        
         	<a href="dataExport.action"><s:text name="link.admin.export"/></a>   <br/>
         	<s:text name="reportAdmin.message.export"/>          	     
        </td>
		</tr>
		</s:if>
  		<s:if test="#session.user.rootAdmin">   
        <tr class="even">
     	<td  class="img-upload">                
         	<a href="dataImport.action"><s:text name="link.admin.import"/></a>  <br/>
         	<s:text name="reportAdmin.message.import"/>                	
        </td>
        </tr>
        </s:if>   		
        ...
        <tr class="even">       	
        <td class="img-stats">         
          <a class="icon" href="analyzeReportLogs.action"><s:text name="link.admin.statistics"/></a><br/>
          <s:text name="reportAdmin.message.statistics"/>        
        </td>     
        </tr>
        </s:if>
        <s:if test="#session.user.logViewer">  
