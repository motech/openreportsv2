/*
/*
 * Copyright (C) 2012 Kiran Krishnamurthy - kiranhk@gmail.com
 * 
...
public class FTPDeliveryMethod implements DeliveryMethod
{  
    protected static Logger log = Logger.getLogger(FTPDeliveryMethod.class.getName());
